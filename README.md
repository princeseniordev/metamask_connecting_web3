...
The full repository can be found [HERE](https://github.com/best-lucky1030/metamask_connecting_web3).
...
## Step 5: Formatting & Styling our Connect Button
...
```
Now we should see: 0.0000 ETH (or if you already have ETH you'll see your account balance). You can grab some Ethereum from the Ropsten faucet [here](https://faucet.ropsten.be/) if you want to see a nice balance :)
